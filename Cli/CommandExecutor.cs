...
/// (SPEC §4b) — they must stay fast and atomic.
/// </summary>
public sealed class CommandExecutor
{
    ...
    // ---- session commands (SPEC §4b — called by the Claude Code hooks) ----
    ...
    /// <summary>Clean shutdown for the installer (PACKAGING.md §3b.1): Close() runs
